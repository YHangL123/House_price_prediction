...
style = styles['Normal']
story = []
story.append(Paragraph(f"The average train rmse is {train_l}",style))
story.append(Paragraph(f"The average valid rmse is {valid_l}",style))
...
pdf_list = [os.path.join(filename) for filename in pdf_list]
pdf_list.sort()
file_merger = PdfFileMerger()
for pdf in pdf_list:
    file_merger.append(pdf)
file_merger.write('House_price_prediction.pdf')
